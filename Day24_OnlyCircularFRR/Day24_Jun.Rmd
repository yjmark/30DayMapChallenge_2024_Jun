...
final_plot99 <- ggdraw() +
  ...
  draw_plot(hawaii_plot99, 0.05, 0.27, 0.3, 0.3)+
  draw_plot(alaska_plot99, -0.05, 0.2, 0.3, 0.3) 

final_plot09 <- ggdraw() +
  draw_plot(mainland_plot09, 0, 0, 1, 1) +
  draw_plot(hawaii_plot09, 0.05, 0.27, 0.3, 0.3) +
  draw_plot(alaska_plot09, -0.05, 0.2, 0.3, 0.3) 

final_plot19 <- ggdraw() +
  draw_plot(mainland_plot19, 0, 0, 1, 1) +
  draw_plot(hawaii_plot19, 0.05, 0.27, 0.3, 0.3) +
  draw_plot(alaska_plot19, -0.05, 0.2, 0.3, 0.3) 
